			...
			<div class="card">
				...
				<div class="card-content collpase show">
					<div class="card-body"> 
                        ...
                        {!! Form::model($category, ['class'=>'form', "id"=>'takeEditcategoryData',]) !!}
						@method("PUT")
						
						{!! Form::hidden("category_id", route('update-category', [$category->slug])) !!}
                        ...
                        <div class="form-body">
								...
								<div class="row">
									<div class="form-group col-12 mb-2">
                                        ...
                                        {!! Form::textarea("description", null, ["id"=>"desc-c", "class"=>"form-control","placeholder"=>"permission details..."]) !!}
                            ...
                            <div class="form-actions text-center">                                    
                                    {!! Form::submit("Update", ["id"=>'editCategory',"class"=>"btn btn-success"]) !!}
