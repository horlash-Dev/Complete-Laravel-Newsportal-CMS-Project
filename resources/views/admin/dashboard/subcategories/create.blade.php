			...
			<div class="card">
				...
				<div class="card-content collpase show">
					<div class="card-body"> 
                        ...
                        {!! Form::open(['route' => 'new-category','class'=>'form', "id"=>'takesub_categoryData']) !!}
                        
                        <div class="form-body">
								<h4 class="form-section"><i  class="ft-settings"></i>Attach a child-Category!</h4>
								...
								<div class="row">
									<div class="form-group col-12 mb-2">
                                        ...
                                        {!! Form::textarea("description", null, ["class"=>"form-control", "id"=>"desc-sc","placeholder"=>"permission details..."]) !!}
                            ...
                            <div class="form-actions text-center">                                    
                                    {!! Form::submit("Publish", ["id"=>'createsub_Category',"class"=>"btn btn-success"]) !!}
