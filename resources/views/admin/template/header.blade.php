      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ route('/')}} "><img class="brand-logo" alt="modern admin logo" src="{{ asset('storage/files')}}/{{$favicon->image ?? null}}">
                <h3 class="brand-text">{{$title ?? null}}</h3></a></li>
          ...
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              @endauth  
               ...
               @else
               <img src="{{asset('storage/avatar/user.png')}}" alt="avatar">  
               @endif
       
                <i></i></span></a>
                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route("u-edit-profile",auth()->user()->username)}}"><i class="ft-user"></i> Edit Profile</a>
                  <div class="dropdown-divider"></div>
                  
                  {!! Form::open(['route'=>'logout','id'=>'out']) !!}
                  
                  <a class="dropdown-item" href="" onclick="event.preventDefault();document.getElementById('out').submit();"><i class="ft-power"></i> Logout</a>
