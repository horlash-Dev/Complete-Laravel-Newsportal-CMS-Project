...
@section('title',  $post->description ?? $post->name)
...
<div class="cat-page-area pd-bottom-80">
    ...
    <ul>
    <li><a class="tag-base tag-light-blue" href="{{$post->Url}}">{{$post->name}}</a></li>
    <li><i class="fa fa-user"></i>{{$item->createdBy->username}}</li>
    </ul>
    </div>
